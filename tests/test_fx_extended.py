...
def con():
    ...
    from pakfindata.db.repositories.fx_extended import init_fx_extended_schema
...
class TestUpsertFxInterbank:
    def test_insert(self, con):
        from pakfindata.db.repositories.fx_extended import upsert_fx_interbank
...
class TestUpsertFxOpenMarket:
    def test_insert(self, con):
        from pakfindata.db.repositories.fx_extended import upsert_fx_open_market
...
class TestUpsertFxKerb:
    def test_insert(self, con):
        from pakfindata.db.repositories.fx_extended import upsert_fx_kerb
...
class TestGetFxRate:
    ...
    def test_not_found(self, con):
        from pakfindata.db.repositories.fx_extended import get_fx_rate
...
class TestGetFxHistory:
    def test_empty(self, con):
        from pakfindata.db.repositories.fx_extended import get_fx_history
...
class TestForexPKScraper:
    ...
    def test_parse_number(self):
        ...
        from pakfindata.sources.forex_scraper import _parse_number
