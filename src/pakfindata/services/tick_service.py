...
Usage:
    python -m pakfindata.services.tick_service              # foreground
    python -m pakfindata.services.tick_service --daemon      # background
    python -m pakfindata.services.tick_service --debug       # print raw WS messages
"""
...
def start_tick_service_background(db_path: Path | None = None) -> tuple[bool, str]:
    ...
    cmd = [sys.executable, "-m", "pakfindata.services.tick_service"]
    if db_path:
