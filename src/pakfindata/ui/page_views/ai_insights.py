...
def render_ai_insights():
    ...
    if generate_clicked:
        try:
            ...
            from pakfindata.agents.llm_client import LLMError, is_api_key_configured, create_client
            from pakfindata.agents.config import get_active_config
            from pakfindata.agents.prompts import PromptBuilder, InsightMode as LLMInsightMode
            from pakfindata.agents.cache import LLMCache, init_llm_cache_schema, get_db_freshness_marker
            from pakfindata.agents.data_loader import DataLoader, format_data_for_prompt
    ...
    with settings_cols[0]:
        with st.expander("💾 Cache Management", expanded=False):
            try:
                from pakfindata.agents.cache import LLMCache, init_llm_cache_schema
