...
def digest_viewer_page():
    from pakfindata.ui.page_views.digest_viewer import render_digest_viewer
    render_digest_viewer()
...
def main():
    ...
    _pages = {
        ...
        "Digest Viewer":      st.Page(digest_viewer_page,     title="Digest Viewer",      url_path="digest"),
    ...
    nav_groups = {
        ...
        "ADMIN":           ["Data Status", "Sync Center", "Jobs Monitor", "Digest Viewer", "Schema Explorer", "App Lineage", "SBP EasyData", "PSX Scraper"],
    }
