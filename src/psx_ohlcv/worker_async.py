...
Usage:
    # As module:
    python -m psx_ohlcv.worker_async --task sync_eod
    python -m psx_ohlcv.worker_async --task sync_eod --symbols OGDC,HBL,MCB
...
class AsyncTaskWorker:
    ...
    async def cancel(self, job_id: str) -> bool:
        ...
        from psx_ohlcv.db import request_job_stop
        con = connect()
