...
class PSXClient:
    ...
    def get_symbols_with_profiles(self) -> list[dict]:
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.query import get_symbols_with_profiles
    ...
    def get_market_indices(self) -> list[dict]:
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.db import get_all_latest_indices
    ...
    def get_index_detail(self, index_code: str, days: int = 30) -> dict:
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.db import get_latest_index, get_index_history
    ...
    def get_market_stats(self) -> dict:
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.db import get_latest_market_stats
    ...
    def get_ohlcv_range(
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.query import get_ohlcv_range
    ...
    def get_company_profile(self, symbol: str) -> dict | None:
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.db import get_company_profile
    ...
    def get_company_financials(
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.db import get_company_financials
    ...
    def get_company_quotes(self, symbol: str, limit: int = 100) -> pd.DataFrame:
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.query import get_company_quotes
    ...
    def get_company_ratios(self, symbol: str) -> pd.DataFrame:
        ...
        if self._mode == "api":
            ...
            from psx_ohlcv.db import get_company_ratios
    ...
    def get_company_payouts(self, symbol: str) -> pd.DataFrame:
        ...
        if self._mode == "api":
            ...
            if self._con is None:
                self._con = self._get_db_connection()
            from psx_ohlcv.db import get_company_payouts
    ...
    def get_company_latest_signals(self, symbol: str) -> dict:
        ...
        if self._con is None:
            self._con = self._get_db_connection()
        from psx_ohlcv.query import get_company_latest_signals
    ...
    def get_company_quote_stats(self, symbol: str) -> dict:
        ...
        if self._con is None:
            self._con = self._get_db_connection()
        from psx_ohlcv.query import get_company_quote_stats
    ...
    def get_latest_market_analytics(self) -> dict | None:
        ...
        if self._con is None:
            self._con = self._get_db_connection()
        from psx_ohlcv.analytics import get_latest_market_analytics
    ...
    def get_top_list(self, list_type: str, limit: int = 5) -> pd.DataFrame:
        ...
        if self._con is None:
            self._con = self._get_db_connection()
        from psx_ohlcv.analytics import get_top_list
    ...
    def get_sector_leaderboard(self) -> pd.DataFrame:
        ...
        if self._con is None:
            self._con = self._get_db_connection()
        from psx_ohlcv.analytics import get_sector_leaderboard
    ...
    def get_data_freshness(self) -> tuple[int | None, str | None]:
        ...
        if self._con is None:
            self._con = self._get_db_connection()
        from psx_ohlcv.ui.components.helpers import get_data_freshness
