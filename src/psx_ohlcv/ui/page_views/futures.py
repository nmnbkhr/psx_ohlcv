...
def _cached_futures_stats(_db_path: str) -> dict:
    from psx_ohlcv.db.repositories.futures import get_futures_stats, init_futures_schema
    con = get_connection()
...
def _cached_futures_dates(_db_path: str) -> list[str]:
    from psx_ohlcv.db.repositories.futures import get_futures_dates
    con = get_connection()
...
def _render_sync(con, stats, migrate_from_eod_ohlcv):
    ...
    from psx_ohlcv.db.repositories.eod import ingest_market_summary_csv
